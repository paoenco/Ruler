...
extension ARKitInteractionFocusSquare {
    ...
    */
    ...
    class Segment: SCNNode {
        ...
        init(name: String, corner: Corner, alignment: Alignment) {
            ...
            material.diffuse.contents = ARKitInteractionFocusSquare.primaryColor
            material.isDoubleSided = true
            material.ambient.contents = UIColor.black
            material.lightingModel = .constant
            material.emission.contents = ARKitInteractionFocusSquare.primaryColor
            geometry = plane
        }
